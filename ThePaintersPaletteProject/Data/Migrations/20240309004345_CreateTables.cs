        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VideoCategoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VideoCategoryName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    DropDown = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoCategory", x => x.VideoCategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ArtId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ArtTitle = table.Column<string>(type: "nvarchar(140)", maxLength: 140, nullable: false),
                    ArtDescription = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtPiece", x => x.ArtId);
                    table.ForeignKey(
                        name: "FK_ArtPiece_Category_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtPieceArtId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    UnitPrice = table.Column<double>(type: "float", nullable: false),
                    ArtPiecesArtId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
